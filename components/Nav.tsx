      ...
      >
        <div className="section-container flex items-center justify-between h-14">
          <div className="flex items-center gap-3">
            <a href="#" className="font-heading text-[18px] text-text tracking-tight" aria-label="Alstro AI home">Alstro</a>
            ...
            {links.map((l) => (
              <a
                ...
                className={`nav-link text-[13px] transition-colors ${
                  active === l.href.slice(1) ? "text-text" : "text-text-secondary hover:text-text"
                }`}
              >
                {l.label}
              </a>
          ...
          <div className="hidden md:block">
            <a href="#validate" className="text-[13px] font-medium bg-text text-bg hover:bg-text/90 px-4 py-[7px] rounded-md transition-colors">
              Partner with us
            </a>
          </div>
          ...
          >
            <div className="section-container flex items-center justify-between h-14">
              <div className="flex items-center gap-3">
                ...
                <span className="flex items-center gap-1.5 text-[10px] font-mono text-accent bg-accent-light border border-accent/15 rounded px-1.5 py-[2px] leading-none uppercase tracking-wider">
                  Beta <span className="w-1.5 h-1.5 rounded-full bg-green pulse-live" />
                </span>
              </div>
            ...
            <div className="flex flex-col items-center justify-center flex-1 gap-6">
              ...
              <a href="#validate" onClick={() => setOpen(false)} className="mt-4 bg-text text-bg px-6 py-2.5 rounded-md text-sm">
                Partner with us
              </a>
            </div>
          </motion.div>
